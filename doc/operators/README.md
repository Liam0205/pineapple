...
|----------|-------------|
| [filter_blocked_creator](filter_blocked_creator.md) | Benchmark stub: simulates blocked-creator filtering. |
| [filter_condition](filter_condition.md) | Removes items where a specified field equals a given value. |
| [filter_impression](filter_impression.md) | Benchmark stub: simulates impression-based filtering. |
...
| Operator | Description |
|----------|-------------|
| [observe_datahub](observe_datahub.md) | Benchmark stub: simulates DataHub MQ write. |
...
| Operator | Description |
|----------|-------------|
| [recall_feed_data](recall_feed_data.md) | Benchmark stub: generates synthetic feed items. |
...
| [reorder_topn_boost](reorder_topn_boost.md) | Benchmark stub: simulates top-N boost reordering. |
...
| [transform_generate_request_id](transform_generate_request_id.md) | Benchmark stub: generates a fixed request ID. |
| [transform_hydrate](transform_hydrate.md) | Benchmark stub: simulates MySQL hydration. |
| [transform_normalize](transform_normalize.md) | Normalizes a numeric item field using min-max scaling to [0, 1]. |
| [transform_query_blocked_creators](transform_query_blocked_creators.md) | Benchmark stub: simulates MySQL blocked-creators query. |
...
| [transform_redis_zrangebyscore](transform_redis_zrangebyscore.md) | Benchmark stub: simulates Redis ZRANGEBYSCORE. |
